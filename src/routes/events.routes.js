...
import { createEvent, deleteEventById, getEvents, getEventsById, updateEvents } from '../controllers/events.js';
...
router.patch('/:id',protect,isModerator,upload.single('image'),updateEvents);
